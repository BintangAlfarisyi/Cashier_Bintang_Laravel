    ...
    <table class="table table-striped rounded overflow-hidden" id="myTable">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $p->alamat }}</td>
                <td>
                    <button type="button" class="btn btn-success btn-size" data-bs-toggle="modal" data-bs-target="#modalFormPelanggan" data-mode="edit" data-id="{{ $p->id }}" data-nama_pelanggan="{{ $p->nama_pelanggan }}" data-email="{{ $p->email }}" data-telpon="{{ $p->telpon }}" data-alamat="{{ $p->alamat }}">
