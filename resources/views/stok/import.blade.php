<div class="modal fade" id="importStok" tabindex="-1" aria-labelledby="importStokModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="importStokModalLabel">Import Data Jenis</h5>
